...
import { VSCodeApp } from '@/components/xp/apps/navigation/VSCodeApp'
import { MinesweeperApp } from '@/components/xp/apps/games/MinesweeperApp'
import { TetrisApp } from '@/components/xp/apps/games/TetrisApp'
import { NotepadApp } from '@/components/xp/apps/document/NotepadApp'
import { CmdApp } from '@/components/xp/apps/system/CmdApp'
import { MediaPlayerApp } from '@/components/xp/apps/other/MediaPlayerApp'
import { DesktopIcon } from '@/components/xp/core/DesktopIcon'
import { StartMenu } from '@/components/xp/core/StartMenu'
import { Taskbar } from '@/components/xp/core/Taskbar'
import { XPCursor } from '@/components/xp/core/XPCursor'
import { TaskManagerApp } from '@/components/xp/apps/tabbed/TaskManagerApp'
...
import { VolumeProvider } from '@/components/xp/contexts/VolumeContext'
import { AudioIframe } from '@/components/xp/apps/other/AudioIframe'
import { useOpenApp } from '@/hooks/system/useOpenApp'
import { useComputerPower, useComputerPowerActions } from '@/components/stores/ComputerPowerStore'
import { AchievementsApp } from '@/components/xp/apps/system/AchievementsApp'
import { Clippy } from '@/components/xp/apps/other/Clippy'
