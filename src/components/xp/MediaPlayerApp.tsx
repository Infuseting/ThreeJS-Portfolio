                ...
                events: {
                    onReady: (event: any) => {
                        ...
                        if (effective === 0) {
                            ...
                            event.target.unMute()
                            event.target.setVolume(effective)
                        }
    ...
    return (
        <div style={{ height: '100%', backgroundColor: '#000', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ flex: 1, position: 'relative', overflow: 'hidden', backgroundColor: '#000' }}>
                <iframe
                    src="https://www.youtube.com/embed/jfKfPfyJRdk?autoplay=0&controls=0&disablekb=1&fs=0&modestbranding=1&playsinline=1&mute=1"
